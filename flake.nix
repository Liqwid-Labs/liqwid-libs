    ...
    in
    {
      ...
      packages = perSystem (system:
        self.flake.${system}.packages // {
          haddock =
            let
              plutarch-script-export-doc = self.flake.${system}.packages."plutarch-script-export:lib:plutarch-script-export".doc;
              pkgs = pkgsFor system;
            in
            pkgs.runCommand "haddock-merge" { } ''
              cd ${self}
              mkdir $out
              cp -r ${plutarch-script-export-doc}/share/doc/* $out
            '';
        });
      ...
      checks = perSystem (system:
        self.flake.${system}.checks // {
          ...
          plutarch-script-export = self.flake.${system}.packages."plutarch-script-export:lib:plutarch-script-export";
        });
